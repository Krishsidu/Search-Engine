...
public class countmatch {
	...
	public void countsearch(String cname) throws IOException{
		...
		File folder = new File("C:\\Users\\user\\eclipse-workspace\\Search Engine\\src\\textfile\\");
		File[] listOfFiles = folder.listFiles();
		
		 for (int i = 0; i < listOfFiles.length; i++) {
		      if (listOfFiles[i].isFile()) {
		    	  arrayList.add("C:\\Users\\user\\eclipse-workspace\\Search Engine\\src\\textfile\\"+listOfFiles[i].getName());
